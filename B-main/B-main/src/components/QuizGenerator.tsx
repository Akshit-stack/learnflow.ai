          ...
          <div className="mt-4 p-4 bg-gray-50 rounded-lg border border-gray-200">
            ...
            <div className="mt-3 space-y-2">
              ...
              <button
                onClick={async () => {
                  try {
                    const testResponse = await fetch(`${import.meta.env.VITE_GEMINI_API_URL || 'https://generativelanguage.googleapis.com/v1beta/models/gemini-1.5-flash:generateContent'}?key=${import.meta.env.VITE_GEMINI_API_KEY || 'AIzaSyAl06y6-UhiKqJChctyPFXyEU5OvmrV-Eg'}`, {
                      method: 'POST',
